...
class BpaTestCase(SkyTempleFilesTestCase[BpaHandler, BpaProtocol[BpaFrameInfoProtocol]]):
    ...
    def test_metadata(self) -> None:
        ...
        self.one.number_of_frames = 2
        self.one.frame_info = self.one.frame_info[:2]
        self.one.number_of_tiles = 3
    ...
    def test_frame_info(self) -> None:
        ...
        self.one.frame_info[0].duration_per_frame = 1
        self.one.frame_info[1].duration_per_frame = 2
        self.one.frame_info[2].duration_per_frame = 3
        self.one.frame_info[3].duration_per_frame = 4
