...
class CompressionContainerHandler(HybridDataHandler[CompressionContainerProtocol], ABC):
    @classmethod
    @abstractmethod
    ...
    @classmethod
    def load_python_writer(cls) -> Type[WriterProtocol[CompressionContainerProtocol]]:
    ...
    def compress(cls, data: bytes) -> CompressionContainerProtocol:
        ...
        return cls.get_model_cls().compress(data)
