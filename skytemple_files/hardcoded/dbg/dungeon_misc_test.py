...
test(
    HardcodedDungeonMisc.get_min_iq_for_exclusive_move_user,
    HardcodedDungeonMisc.set_min_iq_for_exclusive_move_user,
    0x14B, arm9_us, arm9_eu
)
test(
    HardcodedDungeonMisc.get_min_iq_for_item_master,
    HardcodedDungeonMisc.set_min_iq_for_item_master,
    0x96, arm9_us, arm9_eu
)
test(
    HardcodedDungeonMisc.get_intimidator_chance,
    HardcodedDungeonMisc.set_intimidator_chance,
    32, ov10_us, ov10_eu
)
test(
