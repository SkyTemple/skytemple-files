...
from skytemple_files.hardcoded.main_menu_music import MainMenuMusic
...
print(MainMenuMusic.get_main_menu_music(ov00_us, ppmdu_us, ov09_us))
print(MainMenuMusic.get_main_menu_music(ov00_eu, ppmdu_eu, ov09_eu))

MainMenuMusic.set_main_menu_music(123, ov00_us, ppmdu_us, ov09_us)
MainMenuMusic.set_main_menu_music(4, ov00_eu, ppmdu_eu, ov09_eu)
