...
class MetaFramePiece:
    ...
    def GetBounds(self):
        ...
        return (
            start[0],
            start[1],
            start[0] + width * TEX_SIZE,
            start[1] + height * TEX_SIZE,
        )
...
class FrameOffset:
    ...
    def drawOn(self, inImg, exOffset, start, color):
        ...
        srcColor = (
            max(srcColor[0], color[0]),
            max(srcColor[1], color[1]),
            max(srcColor[2], color[2]),
            max(srcColor[3], color[3]),
        )
