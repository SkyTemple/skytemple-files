...
.definelabel BufferRead, 0x020A1FD8
.definelabel RanksFName, 0x020A1FDC
.definelabel RanksFStream, 0x020A1FF0
.definelabel LoadRank, 0x020A1EA8
;LoadRank(r0: floor_id, r1: group_id)
.definelabel FRankHook1, 0x0204FB44
.definelabel FRankHook2, 0x0204FBB0
