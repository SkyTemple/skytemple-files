...
class MappaFloorLayout(AutoString, XmlSerializable, CheckedIntWrites):
        ...
        xml_generator_settings = Element(
            XML_FLOOR_LAYOUT__GENSET,
            {
                ...
                XML_FLOOR_LAYOUT__GENSET__EXTRA_HALLWAY_DENSITY: str(
                    self.extra_hallway_density
                ),
                XML_FLOOR_LAYOUT__GENSET__BURIED_ITEM_DENSITY: str(
                    self.buried_item_density
                ),
        ...
        xml_chances = Element(
            XML_FLOOR_LAYOUT__CHANCES,
            {
                ...
                XML_FLOOR_LAYOUT__CHANCES__EMPTY_MONSTER_HOUSE: str(
                    self.empty_monster_house_chance
                ),
        ...
        xml_misc = Element(
            XML_FLOOR_LAYOUT__MISCSET,
            {
                ...
                XML_FLOOR_LAYOUT__MISCSET__KECLEON_SHOP_ITEM_POSITIONS: str(
                    self.kecleon_shop_item_positions
                ),
                XML_FLOOR_LAYOUT__MISCSET__UNK_HIDDEN_STAIRS: str(
                    self.unk_hidden_stairs
                ),
    ...
    def from_xml(cls, ele: Element) -> "MappaFloorLayout":
        ...
        structure = getattr(
            MappaFloorStructureType, ele.get(XML_FLOOR_LAYOUT__STRUCTURE)
        )
