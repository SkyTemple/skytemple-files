...
class HardcodedMainMenuMusic:
    ...
    def get_main_menu_music(ov00: bytes, config: Pmd2Data, ov09: Optional[bytes] = None) -> Union[int, Tuple[int, int]]:
        ...
        main_block = config.binaries['overlay/overlay_0000.bin'].symbols['MainMenuSongId']
        skyj_block = config.binaries['overlay/overlay_0009.bin'].symbols['MainMenuReturnSongId']
