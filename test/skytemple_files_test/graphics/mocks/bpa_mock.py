...
class BpaMock(BpaProtocol[BpaFrameInfoMock]):
    def __init__(self, data: bytes):
        ...
        self._tiles: List[bytes] = [
            ...
            bytes(b"\xa3\xaa\xaa\xba;\xaa\xbb\xbb\xbb\xab\xbb3\xbb3\xba\xa3;\xbb\xa3\xab\xbb3;237#\xa23;#\xac"),
            bytes(b"wwwwwwwwwwwwwwwwwwwwwwwwswwwswww"),
            bytes(
            ...
            bytes(b"wwwwwww7uw\xb77sw73{w\xb3\xbbsw\xaa\xbbu7\xbb\xbb5s\xa3\xba"),
            bytes(b"3\xbb\xab\xaaw:\xab\xaa;\xbb\xa3\xaaw\xba\xbb[s333z7;\xbawS\xaass\xa3\xaa\xbb"),
            bytes(
                b'\xa2*\xc2\xcc\xa2""\xcc"\xa2\xcc\xccRR\xc5\\"\xc2\xcc\xcc*\xc2\xcc\xcc\xa7\xc2\xcc\xcc\'\xc5\xcc\xcc'
            ),
            bytes(b'2\xb7\xaa\xaa\xb2\xbb\xaa\xaa\xa2\xab+\xaa"\xaa\xaa\xaa"\xa2"\xaa,"\xaa\xa2\xac"\xa2""*\xaa\xa2'),
            bytes(b"3\xba7:;w;\xb3{w7733ws;3s\xba\xaa\xaa\xba\xa5\xa5\xaa\xa5\xaaUUZ\xaa"),
            bytes(b'w\xc5\xcc%w\xcc\\"\xaaR,"*""""""""""""\xa2","""\xc2'),
            bytes(b'**\xa2\xaa\xa2\xa2\xaa*""""*""""\xc2""\xc2\xcc""",,"""""'),
            bytes(
                b"\xaa\xbb\xba\xaa*\xaa\xaa\xab\xba\xba\xba:\xba\xab\xab\xba\xaa\xbb\xaa;*\xba\xaa\xbb\xa2\xa3\xb3\xb3\xa3\xaa\xab:"
            ),
            bytes(b"\xa3\xaa\xaa\xba;\xaa\xbb\xbb\xbb\xab\xbb3\xbb3\xba\xa3;\xbb\xb3;\xbb\xb3\xb3{3\xb7\xb3{3;Z\xb2"),
            bytes(b"wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww"),
            bytes(
                b"\xba\xaa\xa3:\xaa\xab\xba\xa3\xaa*\xaa\xba\xbb\xaa\xaa\xba\xab+\xaa\xba\xab\xba\xaa\xa2\xbb\xab\xab\xaa3\xbb\xaa\xaa"
            ),
            bytes(b"\xb3\xb3\xc5\xb2;\xb7\xc5\xb2;w'\xcc37S\xc53\xb3[\xcc\xba\xbbU\xcc\xbb3\xcc\xcc\xba\xb3\xcc\xcc"),
            bytes(b"wwwwwww7uw\xb77sw73{w\xb3\xbb|w\xaa\xbb|7\xbb\xbb<s\xa3\xba"),
            bytes(b"3\xbb\xab\xaaw:\xab\xaa;\xbb\xa3\xaaw\xba\xbb[s333z7;\xbawS\xaass\xa3\xaa\xbb"),
            bytes(
                b'\xa2*\xcc\xcc\xa2"\xcc\xcc"\xc2\xcc\xccR\xc2\xcc\xcc"\xc2\xcc\xcc*\xc2\xcc\xcc\xa7\xc2\xcc\xcc\'\xc5\xcc\xcc'
            ),
            bytes(b'<\xb7\xaa\xaa\xbc\xbb\xaa\xaa\xac\xab+\xaa,\xaa\xaa\xaa,\xa2"\xaa,"\xaa\xa2\xac"\xa2""*\xaa\xa2'),
            bytes(b"3\xba7:;w;\xb3{w7733ws;3s\xba\xaa\xaa\xba\xa5\xa5\xaa\xa5\xaaUUZ\xaa"),
            bytes(b'w\xc5\xcc,w\xcc\xcc"\xaaR,"*""""""""""""\xa2","""\xc2'),
            bytes(b'**\xa2\xaa\xa2\xa2\xaa*""""*""""\xc2""\xc2\xcc""",,"""""'),
            bytes(
                b"\xaa\xbb\xba\xaa*\xaa\xaa\xab\xba\xba\xba:\xba\xab\xab\xba\xaa\xbb\xaa;*\xba\xaa\xbb\xa2\xa3\xb3\xb3\xa3\xaa\xab:"
            ),
            bytes(b"\xa3\xaa\xaa\xba;\xaa\xbb\xbb\xbb\xab\xbb3\xbb3\xba\xa3;\xbb\xb3;\xbb3;;373\xbb3;#\xac"),
            bytes(b"wwwwwwwwwwwwwwwwwwwwwwwwwwwwswww"),
            bytes(
                b"\xba\xaa\xa3:\xaa\xab\xba\xa3\xaa*\xaa\xba\xbb\xaa\xaa\xba\xab+\xaa\xba\xab\xba\xaa\xa2\xbb\xab\xab\xaa3\xbb\xaa\xaa"
            ),
            bytes(b'\xb3s\xa3%;7[,;w\xcc\\3\xb7U\xc53\xb3R\xcc\xba+U\xcc\xbbR\xcc\xcc\xaa"\xcc\xcc'),
            bytes(b"{www{ww7zw\xb77\xa5w73,w\xb3\xbb\xccw\xaa\xbb\xcc3\xbb\xbb\xccz\xa3\xba"),
            bytes(b"3\xbb\xab\xaaw:\xab\xaa;\xbb\xa3\xaaw\xba\xbb+s33#z7;\xbawS\xaass\xa3\xaa\xbb"),
            bytes(
            ...
            bytes(b"3\xba7:;w;\xb3{w7733ws;3s\xba\xaa\xaa\xba\xa5\xa5\xaa\xa5\xaaUUZ\xaa"),
            bytes(b'\xa7\xc5\xcc\xccw\xc2\xcc"\xaa"%"*""""""""""""\xa2","""\xc2'),
            bytes(b'**\xa2\xaa\xa2\xa2\xaa*""""*""""\xc2""\xc2\xcc""",,"""""'),
            bytes(
                b"\xaa\xbb\xba\xaa*\xaa\xaa\xab\xba\xba\xba:\xba\xab\xab\xba\xaa\xbb\xaa;*\xba\xaa\xbb\xa2\xa3\xb3\xb3\xa3\xaa\xab:"
            ),
                ...
                return [
                    Image.open(
                        os.path.join(
                            ...
                            "data",
                            "bpa",
                            f"tiles_to_pil_separate_pal_{pal_id}_wim_1_0.png",
                        )
                    ),
                    Image.open(
                        os.path.join(
                            ...
                            "data",
                            "bpa",
                            f"tiles_to_pil_separate_pal_{pal_id}_wim_1_1.png",
                        )
                    ),
                    Image.open(
                        os.path.join(
                            ...
                            "data",
                            "bpa",
                            f"tiles_to_pil_separate_pal_{pal_id}_wim_1_2.png",
                        )
                    ),
                    Image.open(
                        os.path.join(
                            ...
                            "data",
                            "bpa",
                            f"tiles_to_pil_separate_pal_{pal_id}_wim_1_3.png",
                        )
                    ),
                    Image.open(
                        os.path.join(
                            ...
                            "data",
                            "bpa",
                            f"tiles_to_pil_separate_pal_{pal_id}_wim_1_4.png",
                        )
                    ),
                    Image.open(
                        os.path.join(
                            ...
                            "data",
                            "bpa",
                            f"tiles_to_pil_separate_pal_{pal_id}_wim_1_5.png",
                        )
                    ),
                ]
