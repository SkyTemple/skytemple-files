...
class MoveAnim(AutoString):
    def __init__(self, data: bytes):
        ...
        self.point = AnimPointType(read_uintle(data, 17, 1))  # type: ignore
...
class GeneralAnim(AutoString):
    def __init__(self, data: bytes):
        self.anim_type = AnimType(read_uintle(data, 0, 4))  # type: ignore
        ...
        self.point = AnimPointType(read_uintle(data, 25, 1))  # type: ignore
...
class SpecMoveAnim(AutoString):
    def __init__(self, data: bytes):
        ...
        self.point = AnimPointType(read_uintle(data, 3, 1))  # type: ignore
