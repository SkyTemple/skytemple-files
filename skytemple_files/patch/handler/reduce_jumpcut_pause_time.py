...
ORIGINAL_BYTESEQ = b"\x3C\x00\x50\xE3"
...
class ReduceJumpcutPauseTime(AbstractPatchHandler):
    ...
    def description(self) -> str:
        return _(
            "Reduces the amount of time the game pauses for before changing the PoV, like when far-off pals is enabled, from 60 frames to 12. This is already applied in the CTC hack."
        )
